// The base path the site is served under ("/faser" on GitHub Pages). Set at
// build time via PAGES_BASE_PATH and exposed to the client as
...
// string references (<img>, fetch, new Worker(url)). Use this there.
