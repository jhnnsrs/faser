...
<Callout type="info" title="Try it in your browser">
The simulator is compiled to WebAssembly and runs directly on this site. Head over to the
[Playground](/playground) to generate and explore PSFs without installing anything.
</Callout>
...
- Multi-core native simulator (Rust) with a pure numpy reference implementation
